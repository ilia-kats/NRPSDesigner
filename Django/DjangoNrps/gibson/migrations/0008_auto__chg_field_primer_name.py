...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Changing field 'Primer.name'
        db.alter_column(u'gibson_primer', 'name', self.gf('django.db.models.fields.CharField')(max_length=200))

    def backwards(self, orm):
        # Changing field 'Primer.name'
        db.alter_column(u'gibson_primer', 'name', self.gf('django.db.models.fields.CharField')(max_length=80))
