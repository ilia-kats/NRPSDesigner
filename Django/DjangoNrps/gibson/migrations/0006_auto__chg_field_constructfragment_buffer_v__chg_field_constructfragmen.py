...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ConstructFragment.buffer_v'
        db.alter_column(u'gibson_constructfragment', 'buffer_v', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=1))

        # Changing field 'ConstructFragment.primer_bottom_v'
        db.alter_column(u'gibson_constructfragment', 'primer_bottom_v', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=1))

        # Changing field 'ConstructFragment.water_v'
        db.alter_column(u'gibson_constructfragment', 'water_v', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=1))

        # Changing field 'ConstructFragment.template_v'
        db.alter_column(u'gibson_constructfragment', 'template_v', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=1))

        # Changing field 'ConstructFragment.dntp_v'
        db.alter_column(u'gibson_constructfragment', 'dntp_v', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=1))

        # Changing field 'ConstructFragment.primer_top_v'
        db.alter_column(u'gibson_constructfragment', 'primer_top_v', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=1))

        # Changing field 'ConstructFragment.total_v'
        db.alter_column(u'gibson_constructfragment', 'total_v', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=1))

    def backwards(self, orm):

        # Changing field 'ConstructFragment.buffer_v'
        db.alter_column(u'gibson_constructfragment', 'buffer_v', self.gf('django.db.models.fields.DecimalField')(max_digits=3, decimal_places=1))

        # Changing field 'ConstructFragment.primer_bottom_v'
        db.alter_column(u'gibson_constructfragment', 'primer_bottom_v', self.gf('django.db.models.fields.DecimalField')(max_digits=3, decimal_places=1))

        # Changing field 'ConstructFragment.water_v'
        db.alter_column(u'gibson_constructfragment', 'water_v', self.gf('django.db.models.fields.DecimalField')(max_digits=3, decimal_places=1))

        # Changing field 'ConstructFragment.template_v'
        db.alter_column(u'gibson_constructfragment', 'template_v', self.gf('django.db.models.fields.DecimalField')(max_digits=3, decimal_places=1))

        # Changing field 'ConstructFragment.dntp_v'
        db.alter_column(u'gibson_constructfragment', 'dntp_v', self.gf('django.db.models.fields.DecimalField')(max_digits=3, decimal_places=1))

        # Changing field 'ConstructFragment.primer_top_v'
        db.alter_column(u'gibson_constructfragment', 'primer_top_v', self.gf('django.db.models.fields.DecimalField')(max_digits=3, decimal_places=1))

        # Changing field 'ConstructFragment.total_v'
        db.alter_column(u'gibson_constructfragment', 'total_v', self.gf('django.db.models.fields.DecimalField')(max_digits=3, decimal_places=1))
