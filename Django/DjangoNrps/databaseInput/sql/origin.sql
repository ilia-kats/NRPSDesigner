...
CREATE FUNCTION `get_origin_parent`(`value` INT) RETURNS INT(11) NOT DETERMINISTIC READS SQL DATA
BEGIN
    DECLARE _id INT;
...
CREATE PROCEDURE `get_origin_hierarchy`(IN `id` INT) NOT DETERMINISTIC READS SQL DATA
SELECT  ori.*
FROM    (
