...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column(u'databaseInput_domaintuple', 'domain_right_id', 'next_domain_id')

        db.rename_column(u'databaseInput_domaintuple', 'position_left', 'prev_position')


        db.rename_column(u'databaseInput_domaintuple', 'domain_left_id', 'prev_domain_id')

        db.rename_column(u'databaseInput_domaintuple', 'position_right', 'next_position')



    def backwards(self, orm):
        db.rename_column(u'databaseInput_domaintuple', 'next_domain_id', 'domain_right_id')

        db.rename_column(u'databaseInput_domaintuple', 'prev_position', 'position_left')


        db.rename_column(u'databaseInput_domaintuple', 'prev_domain_id', 'domain_left_id')

        db.rename_column(u'databaseInput_domaintuple',  'next_position', 'position_right')
