...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Type.pfamGraphic'
        db.add_column(u'databaseInput_type', 'pfamGraphic',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Type.pfamGraphic'
        db.delete_column(u'databaseInput_type', 'pfamGraphic')
