...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NRP.boundary_parent'
        db.add_column(u'designerGui_nrp', 'boundary_parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='boundary_child', null=True, to=orm['designerGui.NRP']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NRP.boundary_parent'
        db.delete_column(u'designerGui_nrp', 'boundary_parent_id')
    ...
    models = {
        ...
        u'designerGui.nrp': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'049961df-ad44-45dc-a2ff-c37ffbde0ec4'", 'max_length': '36', 'db_index': 'True'})
        },
