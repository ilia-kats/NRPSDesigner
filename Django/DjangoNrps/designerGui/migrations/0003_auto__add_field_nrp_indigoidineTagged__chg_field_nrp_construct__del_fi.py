...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NRP.indigoidineTagged'
        db.add_column(u'designerGui_nrp', 'indigoidineTagged',
    ...
    def backwards(self, orm):
        # Deleting field 'NRP.indigoidineTagged'
        db.delete_column(u'designerGui_nrp', 'indigoidineTagged')
