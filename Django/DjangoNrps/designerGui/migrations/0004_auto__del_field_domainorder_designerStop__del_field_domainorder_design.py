...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DomainOrder.designerStop'
        db.delete_column(u'designerGui_domainorder', 'designerStop')

        # Deleting field 'DomainOrder.designerStart'
        db.delete_column(u'designerGui_domainorder', 'designerStart')

        # Adding field 'DomainOrder.linkerBeforeLength'
        db.add_column(u'designerGui_domainorder', 'linkerBeforeLength',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'DomainOrder.linkerAfterLength'
        db.add_column(u'designerGui_domainorder', 'linkerAfterLength',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'DomainOrder.designerStop'
        db.add_column(u'designerGui_domainorder', 'designerStop',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'DomainOrder.designerStart'
        db.add_column(u'designerGui_domainorder', 'designerStart',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'DomainOrder.linkerBeforeLength'
        db.delete_column(u'designerGui_domainorder', 'linkerBeforeLength')

        # Deleting field 'DomainOrder.linkerAfterLength'
        db.delete_column(u'designerGui_domainorder', 'linkerAfterLength')
    ...
    models = {
        ...
        u'designerGui.domainorder': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'linkerAfterLength': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'linkerBeforeLength': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
