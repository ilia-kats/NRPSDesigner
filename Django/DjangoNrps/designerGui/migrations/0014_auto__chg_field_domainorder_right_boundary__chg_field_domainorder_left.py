...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DomainOrder.right_boundary'
        db.alter_column(u'designerGui_domainorder', 'right_boundary', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'DomainOrder.left_boundary'
        db.alter_column(u'designerGui_domainorder', 'left_boundary', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'DomainOrder.right_boundary'
        db.alter_column(u'designerGui_domainorder', 'right_boundary', self.gf('django.db.models.fields.PositiveIntegerField')(default=None))

        # Changing field 'DomainOrder.left_boundary'
        db.alter_column(u'designerGui_domainorder', 'left_boundary', self.gf('django.db.models.fields.PositiveIntegerField')(default=None))
    ...
    models = {
        ...
        u'designerGui.nrp': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'ff707f5a-7ebf-4371-b008-e9b73c6b804e'", 'max_length': '36', 'db_index': 'True'})
        },
