...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DomainOrder.linkerAfterLength'
        db.alter_column(u'designerGui_domainorder', 'linkerAfterLength', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'DomainOrder.linkerBeforeLength'
        db.alter_column(u'designerGui_domainorder', 'linkerBeforeLength', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'DomainOrder.linkerAfterLength'
        db.alter_column(u'designerGui_domainorder', 'linkerAfterLength', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'DomainOrder.linkerBeforeLength'
        db.alter_column(u'designerGui_domainorder', 'linkerBeforeLength', self.gf('django.db.models.fields.IntegerField')(null=True))
