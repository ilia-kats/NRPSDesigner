...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'designerGui_species', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('species', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('taxon_id', self.gf('django.db.models.fields.CharField')(max_length=20)),
        ))
        db.send_create_signal(u'designerGui', ['Species'])

        # Adding model 'NRP'
        db.create_table(u'designerGui_nrp', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('designed', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('construct', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gibson.Construct'], null=True, blank=True)),
        ))
        db.send_create_signal(u'designerGui', ['NRP'])

        # Adding model 'SubstrateOrder'
        db.create_table(u'designerGui_substrateorder', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nrp', self.gf('django.db.models.fields.related.ForeignKey')(related_name='substrateOrder', to=orm['designerGui.NRP'])),
            ('substrate', self.gf('django.db.models.fields.related.ForeignKey')(related_name='substrateOrder', to=orm['databaseInput.Substrate'])),
            ('order', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal(u'designerGui', ['SubstrateOrder'])

        # Adding model 'DomainOrder'
        db.create_table(u'designerGui_domainorder', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nrp', self.gf('django.db.models.fields.related.ForeignKey')(related_name='domainOrder', to=orm['designerGui.NRP'])),
            ('domain', self.gf('django.db.models.fields.related.ForeignKey')(related_name='domainOrder', to=orm['databaseInput.Domain'])),
            ('order', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('designerStart', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('designerStop', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'designerGui', ['DomainOrder'])


    def backwards(self, orm):
        # Deleting model 'Species'
        db.delete_table(u'designerGui_species')

        # Deleting model 'NRP'
        db.delete_table(u'designerGui_nrp')

        # Deleting model 'SubstrateOrder'
        db.delete_table(u'designerGui_substrateorder')

        # Deleting model 'DomainOrder'
        db.delete_table(u'designerGui_domainorder')
    ...
    models = {
        ...
        u'designerGui.domainorder': {
            ...
            'designerStart': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'designerStop': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
