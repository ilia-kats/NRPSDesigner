...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DomainOrder.left_boundary'
        db.add_column(u'designerGui_domainorder', 'left_boundary',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'DomainOrder.right_boundary'
        db.add_column(u'designerGui_domainorder', 'right_boundary',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DomainOrder.left_boundary'
        db.delete_column(u'designerGui_domainorder', 'left_boundary')

        # Deleting field 'DomainOrder.right_boundary'
        db.delete_column(u'designerGui_domainorder', 'right_boundary')
    ...
    models = {
        ...
        u'designerGui.nrp': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'8a7b3884-b064-41ae-9c91-25b9bbe79b89'", 'max_length': '36', 'db_index': 'True'})
        },
