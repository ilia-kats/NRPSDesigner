...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'designerGui_nrp', 'construct_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['gibson.Construct']))
        # Adding unique constraint on 'NRP', fields ['construct']
        db.create_unique(u'designerGui_nrp', ['construct_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'NRP', fields ['construct']
        db.delete_unique(u'designerGui_nrp', ['construct_id'])
    ...
    models = {
        ...
        u'designerGui.nrp': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'ceaa617e-43b5-4c4b-9d25-a8814f581c5e'", 'max_length': '36', 'db_index': 'True'})
        },
