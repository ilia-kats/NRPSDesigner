...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'NRP.construct'
        db.alter_column(u'designerGui_nrp', 'construct_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gibson.Construct'], null=True, on_delete=models.SET_NULL))
        # Adding field 'DomainOrder.gene'
        db.add_column(u'designerGui_domainorder', 'gene',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fragment.Gene'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'NRP.construct'
        db.alter_column(u'designerGui_nrp', 'construct_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gibson.Construct'], null=True))
        # Deleting field 'DomainOrder.gene'
        db.delete_column(u'designerGui_domainorder', 'gene_id')
    ...
    models = {
        ...
        u'designerGui.domainorder': {
            ...
            'gene': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['fragment.Gene']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'designerGui.nrp': {
            ...
            'construct': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['gibson.Construct']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
