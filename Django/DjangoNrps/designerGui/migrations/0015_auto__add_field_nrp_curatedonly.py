...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NRP.curatedonly'
        db.add_column(u'designerGui_nrp', 'curatedonly',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NRP.curatedonly'
        db.delete_column(u'designerGui_nrp', 'curatedonly')
    ...
    models = {
        ...
        u'designerGui.nrp': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'b3248100-1a11-4b68-84d7-fee730fa39a2'", 'max_length': '36', 'db_index': 'True'})
        },
